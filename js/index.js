...
/***/ function(module, exports, __webpack_require__) {
	...
	eval("'use strict';\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _rguiUiListview = __webpack_require__(1);\n\nvar _rguiUiOverlay = __webpack_require__(12);\n\nvar _index = __webpack_require__(19);\n\nvar _index2 = _interopRequireDefault(_index);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n/**\n * @class Menu\n * @extend ListView\n * @param {object}                  options.data                     =  绑定属性\n * @param {boolean=true}            options.data.visible             => 是否显示\n * @param {string=''}               options.data.class               => 补充class\n */\nvar Menu = _rguiUiListview.ListView.extend({\n  name: 'menu',\n  template: _index2.default,\n  /**\n   * @protected\n   * @override\n   */\n  watch: function watch() {/* clear watchers */},\n\n  /**\n   * @method select(item) 选择某一项\n   * @protected\n   * @override\n   * @param  {Item} item 选择项\n   * @return {void}\n   */\n  select: function select(item) {\n    if (this.$outer && this.$outer.$outer instanceof _rguiUiOverlay.Overlay) this.$outer.$outer.toggle(false);\n  }\n});\n\nexports.default = Menu;\n\n/*****************\n ** WEBPACK FOOTER\n ** ./menu/index.js\n ** module id = 18\n ** module chunks = 0\n **/\n//# sourceURL=webpack:///./menu/index.js?");

/***/ },
/* 19 */
/***/ function(module, exports) {

	eval("module.exports =[{\"type\":\"element\",\"tag\":\"ul\",\"attrs\":[{\"type\":\"attribute\",\"name\":\"class\",\"value\":{\"type\":\"expression\",\"body\":\"['m-listView m-menu ',c._sg_('class', d, e)].join('')\",\"constant\":false,\"setbody\":false}},{\"type\":\"attribute\",\"name\":\"z-dis\",\"value\":{\"type\":\"expression\",\"body\":\"c._sg_('disabled', d, e)\",\"constant\":false,\"setbody\":\"c._ss_('disabled',p_,d, '=', 1)\"}},{\"type\":\"attribute\",\"name\":\"r-hide\",\"value\":{\"type\":\"expression\",\"body\":\"(!c._sg_('visible', d, e))\",\"constant\":false,\"setbody\":false}}],\"children\":[{\"type\":\"text\",\"text\":\"\\n    \"},{\"type\":\"template\",\"content\":{\"type\":\"expression\",\"body\":\"c._sg_('$body', c)\",\"constant\":false,\"setbody\":\"c._ss_('$body',p_,c, '=', 0)\"}},{\"type\":\"text\",\"text\":\"\\n\"}]}]\n\n/*****************\n ** WEBPACK FOOTER\n ** ./menu/index.rgl\n ** module id = 19\n ** module chunks = 0\n **/\n//# sourceURL=webpack:///./menu/index.rgl?");
